...
"[project]/bantaybuhay/app/api/analytics/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const mockIncidents = [
    ...
    {
        incident_type: "facial_recognition",
        severity: "medium",
        status: "responding"
    }
];
async function GET(request) {
    ...
    const byType = mockIncidents.reduce((acc, i)=>{
        acc[i.incident_type] = (acc[i.incident_type] || 0) + 1;
        return acc;
    }, {});
    const bySeverity = mockIncidents.reduce((acc, i)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__82e1c3cb._.js.map